        ...
        <div style={{display: 'flex',padding:'30px',justifyContent:'space-between'}}>
          ...
          <div style={{flex:'1',marginRight:'20px'}}>
            ...
            <div style={{marginTop:'50px'}}>
              {/* home */}
              <a href="/" style={{marginRight:'15px',color:'whitesmoke'}}> <i class="bi bi-house"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
  <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" className="icon-path"/>
</svg></i></a>
{/* product */}

<a href ='/products' style={{marginRight:'15px',color:'whitesmoke'}}> <i class="bi bi-shop"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
  ...
  className="icon-path"/>
           ...
           {/* about */}
           <a href="/about" style={{marginRight:'15px',color:'whitesmoke'}}><i class="bi bi-file-person"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-person" viewBox="0 0 16 16">
  <path d="M12 1a1 1 0 0 1 1 1v10.755S12 11 8 11s-5 1.755-5 1.755V2a1 1 0 0 1 1-1zM4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z" className="icon-path"/>
...
<style>
    {`
      a:hover .icon-path {
        fill: red; /* Highlight color on hover */
      }
    `}
  </style>
            </div>
...
{/* contacts */}
          <div style={{flex:'1'}}>
            <h3>Contact Us</h3><hr></hr>
            <address>
        <p style={{ marginLeft:'5rem', padding: 0, textAlign: 'left'}}>
          
          <strong>Address:</strong> Hyderabad<br />
          <strong>Email:</strong>{' '}
          <a href="mailto:shaiknagulmeera24@yahoo.com" style={{textDecoration:'none',color:'white'}}>shaiknagulmeera24@yahoo.com</a><br />
          <strong>Phone:</strong>{' '}
          <a href="tel:+919542846978" style={{textDecoration:'none',color:'white'}}>+91 954 284 6978</a>
